...
fun installSerializers() { if(serializers.isEmpty()) {
    ...
    serializers {
        ...
        add<SepaCollectionKey>(SepaCollectionKey.serializer())
        ...
        add<UpdateSepaMandates>(UpdateSepaMandates.serializer())
        add<UpdateSepaMandateInSepaCollection>(UpdateSepaMandateInSepaCollection.serializer())
        ...
        add<CreateAdHocSepaPayment>(CreateAdHocSepaPayment.serializer())
        ...
        add<SepaPaymentLinks>(SepaPaymentLinks.serializer())
        add<SuccessorKind>(SuccessorKind.serializer())
        add<ReadSepaPaymentLinksByLegalEntity>(ReadSepaPaymentLinksByLegalEntity.serializer())
        add<ReadPersonalSepaPaymentLinks>(ReadPersonalSepaPaymentLinks.serializer())
