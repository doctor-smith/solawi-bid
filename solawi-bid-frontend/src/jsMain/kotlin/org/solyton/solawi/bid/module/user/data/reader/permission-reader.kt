...
fun isGranted(right: ValueWithDescription, contextId: Source<String>): Reader<Application, Boolean> =
...
fun isNotGranted(right: ValueWithDescription, contextId: Source<String>): Reader<Application, Boolean> =
...
fun hasRole(role: ValueWithDescription, contextId: Source<String>): Reader<Application, Boolean> =
