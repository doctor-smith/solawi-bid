...
/**
 * Autogenerated Lens.
 * Read and manipulate [ApplicationManagement.personalApplicationContextRelations]
 */
@ReadWrite val personalApplicationContextRelations: Lens<ApplicationManagement, List<ContextRelation>> by lazy{ Lens(
    get = {whole -> whole.personalApplicationContextRelations},
    set = {part -> {whole -> whole.copy(personalApplicationContextRelations = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [ApplicationManagement.personalApplicationContextRelations]
 */
@ReadWrite fun ApplicationManagement.personalApplicationContextRelations(set: List<ContextRelation>.()->List<ContextRelation> ): ApplicationManagement = copy(personalApplicationContextRelations = set(personalApplicationContextRelations)) 
/**
 * Autogenerated Lens.
 * Read and manipulate [ApplicationManagement.personalModuleContextRelations]
 */
@ReadWrite val personalModuleContextRelations: Lens<ApplicationManagement, List<ContextRelation>> by lazy{ Lens(
    get = {whole -> whole.personalModuleContextRelations},
    set = {part -> {whole -> whole.copy(personalModuleContextRelations = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [ApplicationManagement.personalModuleContextRelations]
 */
@ReadWrite fun ApplicationManagement.personalModuleContextRelations(set: List<ContextRelation>.()->List<ContextRelation> ): ApplicationManagement = copy(personalModuleContextRelations = set(personalModuleContextRelations)) 
/**
 * Autogenerated Lens.
