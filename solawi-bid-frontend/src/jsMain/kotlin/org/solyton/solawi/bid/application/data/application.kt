...
/**
 * Autogenerated Lens.
 * Read and manipulate [Application.availableApplications]
 */
@ReadWrite val availableApplications: Lens<Application, List<org.solyton.solawi.bid.module.application.data.application.Application>> by lazy{ Lens(
    get = {whole -> whole.availableApplications},
    set = {part -> {whole -> whole.copy(availableApplications = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [Application.availableApplications]
 */
@ReadWrite fun Application.availableApplications(set: List<org.solyton.solawi.bid.module.application.data.application.Application>.()->List<org.solyton.solawi.bid.module.application.data.application.Application> ): Application = copy(availableApplications = set(availableApplications)) 
/**
 * Autogenerated Lens.
 * Read and manipulate [Application.personalApplications]
 */
@ReadWrite val personalApplications: Lens<Application, List<org.solyton.solawi.bid.module.application.data.application.Application>> by lazy{ Lens(
    get = {whole -> whole.personalApplications},
    set = {part -> {whole -> whole.copy(personalApplications = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [Application.personalApplications]
 */
@ReadWrite fun Application.personalApplications(set: List<org.solyton.solawi.bid.module.application.data.application.Application>.()->List<org.solyton.solawi.bid.module.application.data.application.Application> ): Application = copy(personalApplications = set(personalApplications)) 
/**
 * Autogenerated Lens.
 * Read and manipulate [Application.personalApplicationContextRelations]
 */
@ReadWrite val personalApplicationContextRelations: Lens<Application, List<ContextRelation>> by lazy{ Lens(
    get = {whole -> whole.personalApplicationContextRelations},
    set = {part -> {whole -> whole.copy(personalApplicationContextRelations = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [Application.personalApplicationContextRelations]
 */
@ReadWrite fun Application.personalApplicationContextRelations(set: List<ContextRelation>.()->List<ContextRelation> ): Application = copy(personalApplicationContextRelations = set(personalApplicationContextRelations))
/**
 * Autogenerated Lens.
 * Read and manipulate [Application.personalModuleContextRelations]
 */
@ReadWrite val personalModuleContextRelations: Lens<Application, List<ContextRelation>> by lazy{ Lens(
    get = {whole -> whole.personalModuleContextRelations},
    set = {part -> {whole -> whole.copy(personalModuleContextRelations = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [Application.personalModuleContextRelations]
 */
@ReadWrite fun Application.personalModuleContextRelations(set: List<ContextRelation>.()->List<ContextRelation> ): Application = copy(personalModuleContextRelations = set(personalModuleContextRelations))
/**
 * Autogenerated Lens.
 * Read and manipulate [Application.userApplications]
 */
@ReadWrite val userApplications: Lens<Application, List<UserApplications>> by lazy{ Lens(
    get = {whole -> whole.userApplications},
    set = {part -> {whole -> whole.copy(userApplications = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [Application.userApplications]
 */
@ReadWrite fun Application.userApplications(set: List<UserApplications>.()->List<UserApplications> ): Application = copy(userApplications = set(userApplications))
/**
 * Autogenerated Lens.
 * Read and manipulate [ApplicationManagement.applicationOrganizationRelations]
 */
@ReadWrite val applicationOrganizationRelations: Lens<ApplicationManagement, List<ApplicationOrganizationRelation>> by lazy{ Lens(
    get = {whole -> whole.applicationOrganizationRelations},
    set = {part -> {whole -> whole.copy(applicationOrganizationRelations = part)}}
) }
/**
 * Autogenerated Setter of a Pseudo Lens
 * Manipulate [ApplicationManagement.applicationOrganizationRelations]
 */
@ReadWrite fun ApplicationManagement.applicationOrganizationRelations(set: List<ApplicationOrganizationRelation>.()->List<ApplicationOrganizationRelation> ): ApplicationManagement = copy(applicationOrganizationRelations = set(applicationOrganizationRelations))
