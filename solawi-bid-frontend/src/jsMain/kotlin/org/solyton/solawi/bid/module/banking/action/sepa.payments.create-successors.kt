...
const val CREATE_SUCCESSORS_FOR_SEPA_PAYMENTS = "CREATE_SUCCESSORS_FOR_SEPA_PAYMENTS"

fun createSuccessorsForPayments(
    data: CreateSepaPaymentSuccessors,
    targetCollectionId: SepaCollectionId,
    nameSuffix: String = ""
): Action<BankingApplication, CreateSepaPaymentSuccessors, ApiSepaPayments> = Action(
    name = CREATE_SUCCESSORS_FOR_SEPA_PAYMENTS.suffixed(nameSuffix),
    reader = { _ -> data },
    endPoint = CreateSepaPaymentSuccessors::class,
